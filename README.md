...
Welcome to the MLM demo. This one page web app demonstrates basic eCommerce functionality. Simply call the index file through your local PHP evironment.
...
Note: Be sure to have your local PHP environment running and access the root folder through localhost. Otherwise, index.html won't be able to call the PHP file.
